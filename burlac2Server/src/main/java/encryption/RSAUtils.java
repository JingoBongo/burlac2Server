...
public class RSAUtils {
    ...
    public static void main(String[] args) {
        try {
            String encryptedString = Base64.getEncoder().encodeToString(encrypt("Dhxdsygfyufh gruighdr ugy7driuf", publicKey));
            System.out.println(encryptedString);
            System.out.println(encryptedString.getBytes().length);
